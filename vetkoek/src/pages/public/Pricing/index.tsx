  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.description}>
        ...
        <Text style={{ marginBottom: heightPercentageToDP("3") }} size="small">
          We don't sell ads. We don't sell data. We don't sell your private
          information. We simply sell an excellent email app - we'd give it away
          for free, but servers and hosting won't pay for themselves. We only
          ask for what we need to run the service, get full access to the app
          for only $3 a month.
        </Text>
        <Marquee />
      </View>
      <View style={styles.description}>
        ...
        <View style={styles.description}>
          ...
          <Text size="small">
            ...
            charge you until you decide you want to become a customer. 100% your
            call, no surprises.
          </Text>
        </View>
        <View style={styles.description}>
        ...
        <View style={styles.description}>
          ...
          <Text size="small">
            ...
            certain markets, and we know there's lots of interest in KeloDraken
            in those markets. We'll consider alternate pricing down the road,
            but for now USD it is.
          </Text>
        </View>
        <View style={styles.description}>
